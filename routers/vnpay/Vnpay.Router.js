...
router.post('/online/payment', async (req, res, next) => {
    ...
    const {amountOder, orderID, moneyShip, note, receiver, phone_receiver, address, email_receiver} = req.body;
    let date = new Date();
    ...
    await saveOrderPayment(amountOder, orderID, moneyShip, note, receiver, phone_receiver, address, email_receiver)
    res.redirect(vnpUrl);
});
